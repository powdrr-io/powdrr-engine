...
#[derive(Deserialize, Serialize, Clone)]
pub struct QueryResultTotalComplex {
    pub value: u64,
    pub relation: String,
}
...
#[derive(Deserialize, Serialize, Clone)]
pub struct TermAggregationBucket {
    pub key: String,
    pub doc_count: u64,
    #[serde(flatten)]
...
#[derive(Deserialize, Serialize, Clone)]
pub struct TermAggregationResult {
...
#[derive(Deserialize, Serialize, Clone)]
pub struct AverageAggregationResult {
    pub value: f64,
    #[serde(flatten)]
    pub aggs: HashMap<String, AggregationResult>,
}
...
#[derive(Deserialize, Serialize, Clone)]
pub struct CardinalityAggregationResult {
    pub value: u64,
    #[serde(flatten)]
    pub aggs: HashMap<String, AggregationResult>,
}
...
#[derive(Deserialize, Serialize, Clone)]
pub struct RangeAggregationBucket {
    pub key: String,
    pub from: u64,
...
#[derive(Deserialize, Serialize, Clone)]
pub struct HistogramAggregationBucket {
    pub key: i64,
...
impl QueryResultsNotFound {
    pub fn to_response(&self) -> ElasticSearchResponse {
...
#[derive(Serialize)]
pub struct SingleDocCreateFailedResult {
