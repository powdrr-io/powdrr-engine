...
pub use powdrr_control_plane::schema_massager::{PowdrrDataType, PowdrrField, PowdrrSchema};
...
impl SqlBuilder {
    pub fn for_query(all_fields: bool) -> Self {
        Self::for_query_with_options(all_fields, "_id_seq_no", true)
    }

    pub fn for_query_with_options(
        all_fields: bool,
    ...
    pub fn push_filter_context(&mut self) -> &mut Self {
        self.filter_stack.get_mut().push(vec![]);
        self
    }

    pub fn pop_filter_context(&mut self, is_and: bool) -> &mut Self {
        self.pop_and_maybe_not_filter_context(is_and, false)
    }

    pub fn pop_and_not_filter_context(&mut self, is_and: bool) -> &mut Self {
    ...
    pub fn filter(&mut self, filter: SqlExpression) -> &mut Self {
        let local_filter_stack = self.filter_stack.get_mut();
...
impl SqlQuery {
    ...
    pub fn build_same(&self, schema: &PowdrrSchema) -> String {
        self.build(schema, schema)
    }

    pub fn build(&self, original_schema: &PowdrrSchema, target_schema: &PowdrrSchema) -> String {
...
pub fn to_powdrr_schema(schema: &Schema) -> PowdrrSchema {
...
pub fn extract_powdrr_schema(value: &Value) -> PowdrrSchema {
...
#[allow(dead_code)]
pub fn extract_powdrr_schema_str(value: &str) -> PowdrrSchema {
...
pub fn extract_powdrr_schema_option(value: &Option<Value>) -> PowdrrSchema {
    if value.is_none() {
