...
pub(crate) fn group_files_by_schema(files: &[FileDescriptor]) -> Vec<Vec<FileDescriptor>> {
...
pub(crate) fn file_may_match_predicates(
...
pub(crate) fn row_group_may_match_predicates(
...
pub(crate) fn column_is_all_null(
    column_stats: &IcebergColumnStats,
    record_count: Option<u64>,
) -> bool {
