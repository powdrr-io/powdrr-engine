...
pub(crate) const CLUSTER_SETTINGS_WITH_DEFAULTS: &str = r#"{
    ...
    "defaults": {
      ...
      "cluster.main_lib.master_service_starvation_logging_threshold": "5m",
      "cluster.main_lib.slow_master_task_logging_threshold": "10s",
      "cluster.main_lib.slow_task_logging_threshold": "30s",
