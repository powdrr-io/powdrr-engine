...
use crate::elastic_search_http_types::AliasPathExtractor;
use crate::elastic_search_http_types::NameAliasPathExtractor;
use crate::elastic_search_http_types::NameIdPathExtractor;
use crate::elastic_search_http_types::NamePathExtractor;
use crate::elastic_search_http_types::QueryStringAliases;
use crate::elastic_search_http_types::QueryStringClusterHealth;
use crate::elastic_search_http_types::QueryStringClusterSettings;
...
use crate::test_api_endpoints::test_v1_set_testing_processing_mode;
use crate::{
...
pub fn router(include_test_apis: bool) -> Router {
    ...
    build_router(chain, pipelines, |route| {
        ...
        route
            ...
            .with_path_extractor::<NamePathExtractor>()
            .to(lakehouse_serving_endpoints::get_serving_config);
        route
            .get("/:name/_serve/layout")
            .with_path_extractor::<NamePathExtractor>()
            .to(lakehouse_serving_endpoints::get_serving_layout_advice);
        route
        ...
        route
            .post("/:name/_serve")
            .with_path_extractor::<NamePathExtractor>()
            .to(lakehouse_serving_endpoints::serve_query);
        route
            .post("/:name/_serve/cache_manager")
            .with_path_extractor::<NamePathExtractor>()
            .to(lakehouse_serving_endpoints::manage_serving_cache);
        route
        ...
        route
            .get("/_search")
            .with_query_string_extractor::<QueryStringSearchExtractor>()
